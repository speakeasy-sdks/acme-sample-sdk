...
<div align="left">
    ...
    <a href="https://github.com/speakeasy-sdks/acme-sample-sdk.git/actions"><img src="https://img.shields.io/github/actions/workflow/status/speakeasy-sdks/acme-sample-sdk/speakeasy_sdk_generation.yml?style=for-the-badge" /></a>
...
```bash
npm add https://github.com/speakeasy-sdks/acme-sample-sdk
```

### Yarn

```bash
yarn add https://github.com/speakeasy-sdks/acme-sample-sdk
```
